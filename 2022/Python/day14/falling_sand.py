...
def get_sand_stop_pos():
  ...
  while current_pos[1] > left_edge and current_pos[1] < right_edge and current_pos[0] < bottom_edge:
...
while True:
  ...
  if sand_stop_pos[1] <= left_edge or sand_stop_pos[1] >= right_edge or sand_stop_pos[0] == bottom_edge:
    break
