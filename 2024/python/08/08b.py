...
def setNodes(key, ant1, ant2):
  ...
  numSteps = int(max(numRows / abs(ant1[0] - ant2[0]), numCols / abs(ant1[1] - ant2[1]))) + 1
  if ant1[0] > ant2[0] and ant1[1] > ant2[1]:
    for i in range(1, numSteps):
      if isPositionInMap((ant1[0] + i * dist[0]), (ant1[1] + i * dist[1])):
        nodes.add(((ant1[0] + i * dist[0]), (ant1[1] + i * dist[1])))
      if isPositionInMap((ant2[0] - i * dist[0]), (ant2[1] - i * dist[1])):
        nodes.add(((ant2[0] - i * dist[0]), (ant2[1] - i * dist[1])))
